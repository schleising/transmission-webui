...
var SHELL = [
  "/transmission/web/",
  "/transmission/web/index.html?v1.0.1",
  "/transmission/web/app.css?v1.0.1",
  "/transmission/web/boot.js?v1.0.1",
  "/transmission/web/format.js?v1.0.1",
  "/transmission/web/rpc.js?v1.0.1",
  "/transmission/web/app.js?v1.0.1",
  "/transmission/web/manifest.webmanifest?v1.0.1",
  "/transmission/web/icons/favicon.svg?v1.0.1",
  "/transmission/web/icons/icon-192.png?v1.0.1",
  "/transmission/web/icons/icon-512.png?v1.0.1",
  "/transmission/web/icons/icon-maskable-512.png?v1.0.1"
];
